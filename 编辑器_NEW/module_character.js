/**
 * 🎭 角色/UI 编辑器模块 (Actor & UI Architect - V3.5 核心元数据升维版)
     ...
     setup() {
         ...
         const normalizeData = (data) => {
             ...
             data.actors.forEach(actor => {
                 ...
                 // 历史数据迁移：如果用户以前存了 hp 但没有 mhp，则将 mhp 设置为与 hp 相等
                 ...
                 if (!actor.portrait) actor.portrait = { useOverride: false, overrideName: "" };
             });
         };
         ...
         const addActor = () => {
             ...
             currentActors.push({
                 ...
                 customProps: [],
                 actionPatterns: [], 
                 portrait: { useOverride: false, overrideName: "" }
             });
         ...
         return {
             ui, actors, settings, activeActor,
                 ...
                 <div class="v10-doll-content cm-custom-scroll" v-if="activeActor">
                     ...
                     <div class="v10-layout-bottom">
                         ...
                         <div class="v10-doll-card" v-if="!activeActor.isProtagonist" style="height: 100%;">
                             <div class="v10-doll-card-header">🖼️ 视觉挂载与静态回退 (Fallback)</div>
                             <div class="v10-doll-card-body">
